...
3. [hashTable2 .js](Codes_and_Assets/hashTables2.js)
...
_Hash tables are asked in interviews to improve time complexity_
...
- **_FIFO:_** **F**irst **I**n **F**irst **O**ut
